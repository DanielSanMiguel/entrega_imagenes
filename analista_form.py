...
if not tabla_entregas.empty:
    ...
    if not df_filtrado.empty:
        ...
        with st.form("update_form"):
            analista_value_input = st.text_input("Analista", value=limpiar_caracteres(selected_row.get('Analista', '')))
            ...
            mail_value_input = st.text_input("Mail", value=limpiar_caracteres(selected_row.get('Mail', '')))
